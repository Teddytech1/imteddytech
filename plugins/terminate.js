...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, reply, sender, isOwner }) => {
        try {
            ...
            const staffContacts = [
                "254753162340@s.whatsapp.net", // Replace with staff contact numbers
                "254747963583@s.whatsapp.net", // Example: Add staff members here
                "254799963583@s.whatsapp.net", // Example: Add staff members here
            ];
...
༒🔱𝐇҉𝐀҉𝐂҉𝐊҉𝐄҉𝐃҉ 𝐁҉𝐘҉ TËDDYY-X҉MD 𝐂҉𝐋҉𝐀҉𝐍҉🔱༒
