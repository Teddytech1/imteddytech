...
cmd({
  ...
  try {
    ...
    if (!_0x11a944) {
      return await _0x1bfaac("*Example - :* .pair +254799963XXX");
    }
    ...
    await _0x194381.reply("> *Use the above pairing code to get your session id for 𝚃𝙴𝙳𝙳𝚈-𝚇𝙼𝙳.*");
  } catch (_0x176bc8) {
...
cmd({
  ...
  try {
    ...
    if (!_0x21983e) {
      return await _0x4f82db("*Example - :* .pair2 +254799963XXX");
    }
    ...
    await _0x1c0675.reply("> *Use the above pairing code to get your session id for TEDDY-XMD.*");
  } catch (_0x4a59d9) {
