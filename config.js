...
// make true if want auto voice reply if someone menetion you 
    MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/9yy6iy.jpg",
...
PREFIX: process.env.PREFIX || ".",
  ...
  // Timezone for the auto-bio feature
    TIME_ZONE: process.env.TIME_ZONE || "Africa/Nairobi",  // Change to your preferred timezone
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© POWERED TEDDY TECH HUB*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/13nyhx.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> Powered by *TEDDY TECH*⚡",
// add alive msg here 
